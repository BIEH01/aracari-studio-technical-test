	...
	return (
		<main>
			<section className="w-full h-auto">
				<h1 className="text-white border-white border-b-[1px] mx-auto w-[90%] pl-3 max-w-[1500px]">
				...
				<div className="w-fit h-auto mx-auto md:flex md:flex-wrap md:justify-center md:items-center lg:w-full lg:my-10 max-w-[1650px]">
